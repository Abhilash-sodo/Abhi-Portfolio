          ...
          >
            ...
            <form className="my-8">
              ...
              <LabelInputContainer className="mb-4">
                ...
                <Input
                  id="email"
                  placeholder="projectManhattan@ab.com"
                  type="email"
                />
              </LabelInputContainer>
              <LabelInputContainer className="mb-4">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <button
                  ...
                  type="submit"
                >
                  <IconBrandHackerrank  className="h-4 w-4 text-neutral-800 dark:text-neutral-300" />
                  <span className="text-neutral-700 dark:text-neutral-300 text-sm">
                    <a href="https://www.hackerrank.com/profile/Abhilash69" target="_blank">HackerRank</a>
                  </span>
                  <BottomGradient />
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-neutral-700 dark:text-neutral-300 text-sm">
                    <a href="https://linkedin.com/in/abhilash-sahu-52674222a/" target="_blank">LinkedIn</a>
                  </span>
                  <BottomGradient />
                </button>
              </div>
          ...
          >
            <ButtonsCard>
              ...
              <div className="flex flex-col gap-2">
                ...
                <label className="text-xl lg:text-2xl">+91 8457 839 046</label>
              </div>
            </ButtonsCard>
            ...
            <ButtonsCard>
              ...
              <div className="flex flex-col gap-2">
                ...
                <label className="text-xl lg:text-2xl">
                  132/3, jalahalli cross Bengaluru-560057
                </label>
              </div>
            </ButtonsCard>
          </motion.div>
